...
<div class="card shadow-sm">
    <div class="card-body">
        <h2 class="card-title h5 mb-1">Log Interaction</h2>
        <p class="text-muted small mb-4">Company: <strong><?= Html::encode($company->name) ?></strong></p>
